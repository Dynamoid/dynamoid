...
module Dynamoid
  module Criteria
    ...
    class Chain
      ...
      #
      # +where+ accepts conditions in form of a hash.
      #
      #   Post.where(links_count: 2)
      #
      # A key could be either string or symbol.
      #
      # In order to express contitions other than equality predicates could be used.
      ...
      # - +not_contains+ - check for absense of substring or a value in set or array
      # - +null+ - attribute doesn't exists in an item
      # - +not_null+ - attribute exists in an item
      #
      # All the predicated match operators supported by DynamoDB's {ComparisonOperator}[https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_Condition.html#DDB-Type-Condition-ComparisonOperator]
      #
      ...
      #
      # +where+ whithout argument will return the current chain.
      #
      ...
      # By default reads are eventualy consistent.
      #
      ...
      # the only way to get result as collection is to call the +all+ method.
      # It returns +Enumerator+ which could be used directly or transformed
      # into +Array+
      #
      #   Post.all                            # => Enumerator
      ...
      #
      # When result set is too large DynamoDB divides it into separate pages.
      # While an enumerator iterates over the result models each page is
      # loaded lazily. So even extra large result set can be loaded and
      ...
      #
      # Internaly it uses either `Scan` or `Query` DynamoDB's operation so it
      ...
      # testing.
      #
      # If used without criteria it just returns the last item of some arbitraty order.
      #
      #   Post.last
      #
      ...
      #
      # It could be very inefficient in terms of HTTP requests in patological
      ...
      # the specified size instead of relying on the default paging mechanizm
      # of DynamoDB.
      #
      ...
      #
      # It can be used to implement own pagination mechanizm.
      #
