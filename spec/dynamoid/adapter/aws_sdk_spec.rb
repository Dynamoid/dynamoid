...
describe Dynamoid::Adapter::AwsSdk do
  ...
  context 'with a preexisting table with paritioning' do
    ...
    context 'range queries' do
      before do
        Dynamoid::Adapter.put_item(test_table3, {:id => '1.1', :range => 1.0})
        Dynamoid::Adapter.put_item(test_table3, {:id => '1.1', :range => 3.0})
      end
    ...
    context 'correct ordering ' do
      before do
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.1', :range => 1.0})
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.2', :range => 2.0})
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.3', :range => 3.0})
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.4', :range => 4.0})
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.5', :range => 5.0})
        Dynamoid::Adapter.put_item(test_table4, {:id => '1.6', :range => 6.0})
      end
